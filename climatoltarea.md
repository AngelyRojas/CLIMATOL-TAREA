...
![](climatoltarea_files/figure-gfm/unnamed-chunk-2-1.png)<!-- -->
...
#03 **Convertir la data diaria de tmax en una data de medias
...
```
    ...
    ## 
    ## 
    ## ======== End of homogenization of overlapping areas, after 1.75 mins 
    ## 
    ## ----------- Generated output files: -------------------------
    ## 
